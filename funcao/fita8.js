...
<div class="fita-container" style="max-width: 700px; text-align: center;">
    ...
    <img src="../final.png" style="width: 100%; max-height: 300px; object-fit: contain; border: 1px solid #ff2a2a; box-shadow: 0 0 20px rgba(255, 42, 42, 0.5); margin: 15px 0;">
    ...
    <div style="font-size: 1.1rem; line-height: 1.9; text-align: justify; background: rgba(12,12,12,0.9); padding: 20px; border: 1px solid #444; border-left: 3px solid #ff2a2a; margin-bottom: 20px;">
        ...
        <p>Eu, o observador <strong>M-27</strong>, nem sempre estive do seu lado, mas pretendo acompanhar seus passos com todo o amor do mundo, te apoiando e guardando cada lembrança nossa como o tesouro mais valioso de todos.</p>
        <p style="margin-bottom: 0;">Obrigado por ser minha parceira e por dividir essa pequena quantidade de vida comigo. <strong>Feliz mês-versário! Te amo muito.</strong></p>
    </div>
