...
function verificarResposta() {
    ...
    if (resposta === "D") {
        ...
        try { FitasUI.showError('Fragmento inválido — tente observar a partitura e identificar a nota ausente.'); } catch(e) { alert('Resposta incorreta.'); }
    }
}